const experienceData = [
...

  {
    ...
    address: "Remote",
    companyLink: "https://www.montuapps.com/",
    work: "Elevated Montu's app: 20% more engagement, 15% better functionality. Improved usability, cut loading time by 25%, and integrated APIs for enhanced features. Used animations for a 30% boost in user retention. Active in 50+ code reviews, engineered CI/CD for 40% faster updates.",
  },
  {
    position: "Flutter Developer",
    company: "Aqtar Design",
    time: "December 2020 - March 2022",
    address: "Zizinia, Alexandria",
    companyLink: "https://aqtardesign.com/",
    work: "I collaborated with the design team to boost communication channels, achieving a 20% rise in user engagement. Through code optimization and reviews, I enhanced application performance by 30%. Staying updated on industry trends, I implemented innovative solutions, reducing process time by 25%.",
  },
];
